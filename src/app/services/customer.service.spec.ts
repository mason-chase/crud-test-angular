...
describe('CustomerService', () => {
    ...
    it('should not add a duplicate customer to the list', () => {
        ...
        const existingCustomer = new Customer(firstName, lastName, dateOfBirth, phoneNumber, email, bankAccountNumber);
        const newCustomer = new Customer(firstName, lastName, dateOfBirth, phoneNumber, email, bankAccountNumber);
